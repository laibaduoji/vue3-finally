...
const updateTheme = (mode) => {
  ...
  if (reownLogo) {
    reownLogo.src =
      mode === "dark" ? "/reown-logo-white.png" : "/reown-logo.png";
  }
};
...
<template>
  <div>
    <div class="page-container" id="app">
      <h1 class="page-title">HTML AppKit Wallet Button Example</h1>
      ...
      <div class="action-button-list">
        <button id="connect-google">Connect to Google</button>
        <button id="connect-metamask">Connect to MetaMask</button>
        <button id="connect-walletConnect">Connect to WalletConnect</button>
